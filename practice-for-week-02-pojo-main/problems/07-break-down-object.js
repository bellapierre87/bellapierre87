...
function breakDownObj(obj) {
  ...
  let keys = Object.keys(obj)   // assign all the keys of obj to an array
  let values = Object.values(obj)  // assign all the values of obj to an array
  let kv = [...keys, ...values];    // spread both arrays to merge them into a big array
  return kv;
}
